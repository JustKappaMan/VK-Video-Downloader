...
* Любые браузеры с поддержкой [Tampermonkey](https://www.tampermonkey.net/)
  ...
  * Скопируйте в него содержимое файла [tampermonkey/desktop.js](https://github.com/JustKappaMan/VK-Video-Downloader/tampermonkey/desktop.js) и сохраните его
  * Создайте в Tampermonkey новый скрипт, __удалите из него весь стартовый код__
  * Скопируйте в него содержимое файла [tampermonkey/mobile.js](https://github.com/JustKappaMan/VK-Video-Downloader/tampermonkey/mobile.js) и сохраните его
## Как пользоваться
